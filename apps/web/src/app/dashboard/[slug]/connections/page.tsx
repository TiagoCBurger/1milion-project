...
import { Cable, Key, Link2, Shield } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="p-6 space-y-8">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">MCP Connections</h1>
          <p className="text-muted-foreground mt-1">
            All clients connected to this workspace — via API key or OAuth.
          </p>
        </div>
